...
a = np.load("numpy_files/ResNet/a.npy")
b = np.load("numpy_files/ResNet/b.npy")
c = np.load("numpy_files/ResNet/c.npy")
d = np.load("numpy_files/ResNet/d.npy")

### supervised_model_scratch
a1 = np.load("numpy_files/ResNet/a1.npy")
b1 = np.load("numpy_files/ResNet/b1.npy")
c1 = np.load("numpy_files/ResNet/c1.npy")
d1 = np.load("numpy_files/ResNet/d1.npy")

###  dino_model_finetuned
a_ = np.load("numpy_files/ResNet/a_.npy")
b_ = np.load("numpy_files/ResNet/b_.npy")
c_ = np.load("numpy_files/ResNet/c_.npy")
d_ = np.load("numpy_files/ResNet/d_.npy")

### dino_model_transfer_learning
a1_ = np.load("numpy_files/ResNet/a1_.npy")
b1_ = np.load("numpy_files/ResNet/b1_.npy")
c1_ = np.load("numpy_files/ResNet/c1_.npy")
d1_ = np.load("numpy_files/ResNet/d1_.npy")
...
# plt.savefig("plots/ResNet/moving_average_validation_accuracy.png")
# plt.show()
...
# plt.savefig("plots/ResNet/moving_average_validation_loss.png")
# plt.show()
...
plt.savefig("plots/ResNet/moving_average_training_loss.png")
plt.show()
...
# plt.ylabel("Validation Accuracy")
# plt.title("Moving Average Validation Accuracy")
# plt.savefig("plots/ResNet/side_by_side.png")
# plt.show()
...
# plt.savefig("plots/ResNet/training_loss.png")
# plt.show()
...
plt.savefig("plots/ResNet/validation_accuracy.png")
plt.show()
...
# plt.savefig("plots/ResNet/validation_loss.png")
# plt.show()